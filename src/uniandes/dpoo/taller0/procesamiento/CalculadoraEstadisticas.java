...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais del atleta indicado por el usuario
	 */
	public String PaisAtleta(String nombreAtleta)
	{
		Atleta elle = buscarAtleta(nombreAtleta);
		Pais paise = elle.darPais();
		String nombrePaisdeelle = paise.darNombre();
		
		return nombrePaisdeelle;
	}
