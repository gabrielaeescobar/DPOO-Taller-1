...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pais de un atleta por su nombre\n");
	}
	...
	{
		System.out.println('\n'+ "Pais de un atleta segun su nombre"+'\n');
		String nombre = input("Ingrese el nombre del atleta que quiera consultar");
		String rps = calculadora.PaisAtleta(nombre);
		System.out.println("El  atleta "+ nombre + " es de "+ rps);
